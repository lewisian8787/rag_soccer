...
- Role-specific position questions (e.g. "best right winger", "best number 10", "best false 9") → rag only — structured data only stores broad positions (GK/DEF/MID/FWD) and cannot resolve specific roles
